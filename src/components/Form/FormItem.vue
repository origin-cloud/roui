<template>
  ...
  >
    <label class="ro-form-item__label">
      <slot name="label" :label="label">
        {{ label }}
      </slot>
    </label>
    <div class="ro-form-item__content">
      <slot :validate="validate" />
      <div class="ro-form-item__error-msg" v-if="validateStatus.state === 'error'">
...
const isRequired = computed(() => {
  if (!itemRules.value) return false
