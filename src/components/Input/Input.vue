<template>
  ...
  >
    ...
    <template v-if="type !== 'textarea'">
      <!-- prepend slot -->
      <div v-if="$slots.prepend" class="ro-input__prepend">
        <slot name="prepend" />
      </div>
      <div class="ro-input__wrapper">
        <!-- prefix slot -->
        <span v-if="$slots.prefix" class="ro-input__prefix">
          <slot name="prefix" />
        </span>
        <input
      ...
      <!-- append slot -->
      <div v-if="$slots.append" class="ro-input__append">
        <slot name="append" />
      </div>
    </template>
    <!-- textarea -->
